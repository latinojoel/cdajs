 ...
 * <br/><br/> <b>CDAjs</b> is cross-browser and <a
 ...
 (function (window) {
   ...
   */
   ...
   function _invokeEndpoint(callback, options, endpoint, self) {
    ...
    options.url = (options.url || self.options.url) + endpoint + (options.method.toUpperCase() === "GET" ? (options.form || "") : "");
    xhr.open(options.method, options.url, options.async || CDA.DEFAULT_OPTIONS.ASYNC, options.username, options.password);
   ...
   */
   ...
   function CDA(options) {
    ...
    this.options.params.outputIndexId = options.params.outputIndexId || 1;
  }
   ...
   */
   CDA.prototype.listQueries = function (callback, options) {
    ...
    // Is mandatory use param soltion
    if (_isUnd(options.params.solution)) {
      CDA.Exception.newError("ERROR_MISSING_PARAMS_SOLUTION", endpoint, null)._throw();
    }
    ...
    // Is mandatory use param fike
    if (_isUnd(options.params.file)) {
      CDA.Exception.newError("ERROR_MISSING_PARAMS_FILE", endpoint, null)._throw();
    }
  ...
  /**
   * Exception code indicating that missing solution property on object params for invoke CDA endpoint.
   *
   * @property ERROR_MISSING_PARAMS_SOLUTION_CODE
   * @static
   * @final
   * @type {int}
   * @default -8
   */
   CDA.Exception.ERROR_MISSING_PARAMS_SOLUTION_CODE = -8;
   CDA.Exception.ERROR_MISSING_PARAMS_SOLUTION_MSG = "Missing solution property on object params";
   CDA.Exception.ERROR_MISSING_PARAMS_SOLUTION_HELP = "Please provide solution property on params (Please consult this page " + CDAWikiExceptionCodes + ")";
  ...
  /**
   * Exception code indicating that missing file property on object params for invoke CDA endpoint.
   *
   * @property ERROR_MISSING_PARAMS_FILE_CODE
   * @static
   * @final
   * @type {int}
   * @default -10
   */
   CDA.Exception.ERROR_MISSING_PARAMS_FILE_CODE = -10;
   CDA.Exception.ERROR_MISSING_PARAMS_FILE_MSG = "Missing file property on object params";
   CDA.Exception.ERROR_MISSING_PARAMS_FILE_HELP = "Please provide file property on params (Please consult this page " + CDAWikiExceptionCodes + ")";
